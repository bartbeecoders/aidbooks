...
use crate::handlers::admin::{
    ...
    CreateAudiobookCategoryRequest, CreateLlmRequest, OpenAiCompatModelList, OpenAiCompatModelRow,
    OpenAiModelsRequest, OpenRouterModelList, OpenRouterModelRow, RevokeSessionsResponse,
    PullMoldModelResponse, SystemOverview, TestImageLlmRequest, TestImageLlmResponse,
    TestLlmRequest, TestLlmResponse, TestVoiceRequest, TestVoiceResponse,
    UnloadMoldModelsResponse,
    UpdateAudiobookCategoryRequest, UpdateLlmRequest, UpdateUserRequest, UpdateVoiceRequest,
...
#[openapi(
    ...
    paths(
        ...
        crate::handlers::admin::test_image_llm,
        crate::handlers::admin::test_voice,
        crate::handlers::admin::pull_mold_model,
        crate::handlers::admin::unload_mold_models,
        ...
        crate::handlers::admin::list_openai_compat_models,
        ...
        crate::handlers::queue::remove_item,
        // --- Analytics dashboard ---
